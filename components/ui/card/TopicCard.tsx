...
export default function TopicCard ({id, name, cards, testAction, cardListAction, addCardAction} : TopicType) {
    return (
        ...
        <div className="flex space-x-4">
          ...
          <Button iconType="add" text="Add Card" action={addCardAction} />
          <Button iconType="list" text="View Cards" action={cardListAction} />
        </div>
      </div>
    )
}